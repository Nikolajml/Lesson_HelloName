...
namespace Lesson_HelloName.Classes.Lesson_7_classes
{
    ...
    {
        public Train(string destination, int number, string departureTime, int places, string kindOfTransport) : base(destination, number, departureTime, places, kindOfTransport)
        {
        }
